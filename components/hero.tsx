      ...
      <div className="container mx-auto max-w-5xl z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
                <a
                  className="group inline-flex items-center justify-center px-4 py-2 border border-transparent text-lg font-medium rounded-md text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
